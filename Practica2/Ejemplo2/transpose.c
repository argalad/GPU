...
int main (int argc, char **argv)
{
	...
	err = clEnqueueWriteBuffer(commands, darray1D, CL_TRUE, 0, sizeof (float) * n * n, array1D, 0, NULL, NULL);
	...
	err = clEnqueueReadBuffer (commands, darray1D_trans, CL_TRUE, 0, sizeof (float) * n * n, array1D_trans_GPU, 0, NULL, NULL);
	if (err != CL_SUCCESS)
	{	
